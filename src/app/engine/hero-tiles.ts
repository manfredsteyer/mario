...
async function loadHeroTileFromBitmap(
  bitmap: ImageBitmap,
  p: Palette,
  row: number,
  col: number
...
async function loadHeroTiles(bitmap: ImageBitmap) {
  ...
  const tilePromises = {
    stand: loadHeroTileFromBitmap(bitmap, idlePalette, 0, 0),

    run1: loadHeroTileFromBitmap(bitmap, runPalette, 0, 0),
    run2: loadHeroTileFromBitmap(bitmap, runPalette, 1, 0),
    run0: loadHeroTileFromBitmap(bitmap, runPalette, 2, 0),

    standLeft: flip(loadHeroTileFromBitmap(bitmap, idlePalette, 0, 0)),
    run1Left: flip(loadHeroTileFromBitmap(bitmap, runPalette, 0, 0)),
    run2Left: flip(loadHeroTileFromBitmap(bitmap, runPalette, 1, 0)),
    run0Left: flip(loadHeroTileFromBitmap(bitmap, runPalette, 2, 0)),
  };
